...
export function WorkspaceShell({ muns, currentMun, role, children }: WorkspaceShellProps) {
  return (
    <div className="flex min-h-full flex-1 bg-surface-soft/55 lg:h-dvh lg:overflow-hidden">
      <aside className="hidden w-[18rem] shrink-0 border-r border-sidebar-border bg-background lg:block lg:h-dvh">
