...
| `RL_*` (19) | binding | yes | Workers Rate Limiting bindings (`ratelimits` in `wrangler.jsonc`, namespace ids 1001-1019). A missing binding falls back to an in-memory counter per isolate. |
