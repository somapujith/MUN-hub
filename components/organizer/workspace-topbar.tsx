...
/**
 * Workspace top bar — deliberately NOT `SiteHeader`.
 *
 * The marketing header carries discovery chrome (search, city picker, browse
 * links, a "List your MUN" CTA) that is noise once you're inside the tool you
 * were being sold. This bar carries only: where am I (breadcrumb + live status
 * of the MUN in context), and who am I (account menu). Navigation lives in the
 * rail, so it isn't repeated here.
 *
 * 56px tall against the marketing nav's 64px — a workspace trades vertical
 * chrome for content.
 */
