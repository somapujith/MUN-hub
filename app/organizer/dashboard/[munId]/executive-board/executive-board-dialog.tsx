    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
        ...
        <form action={handleSubmit} className="flex flex-col gap-md">
          ...
          <div className="flex flex-col gap-xs"><Label htmlFor="eb-social-links">Website or social link</Label><Input id="eb-social-links" name="socialLinks" type="url" defaultValue={(member?.socialLinks as { website?: string } | null | undefined)?.website ?? ""} disabled={pending} placeholder="https://..." /></div>
